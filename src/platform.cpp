    ...
    , m_lcdTexturePitch{PPU::lcdWidth * sizeof(uint16)}
{
    ...
    m_lcdTexture = SDL_CreateTexture(m_renderer, SDL_PixelFormat::SDL_PIXELFORMAT_RGB565 , SDL_TextureAccess::SDL_TEXTUREACCESS_STREAMING, PPU::lcdWidth, PPU::lcdHeight);
