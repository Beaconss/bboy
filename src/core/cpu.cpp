...
void CPU::LD_r_HL()
{
	...
	case 1:
		...
		break;
	case 2:
		m_registers[m_iState.x] = m_bus.read(getHL());
		m_cycleCounter = 0;
		m_currentInstr = nullptr;
		break;
	}
...
void CPU::LD_HL_r()
{
	...
	case 2:
		...
		m_bus.write(getHL(), m_registers[m_iState.x]);
		m_cycleCounter = 0;
		m_currentInstr = nullptr;
		break;
	}
...
void CPU::LD_HL_n()
{
	...
	case 1:
		...
		break;
	case 2:
		m_iState.x = m_bus.read(m_PC++); //n
		break;
	case 3:
		m_bus.write(getHL(), m_iState.x);
		m_cycleCounter = 0;
		m_currentInstr = nullptr;
		break;
	}
...
void CPU::LD_A_BC()
{
	...
	case 1:
		...
		break;
	case 2:
		m_registers[A] = m_bus.read(getBC());
		m_cycleCounter = 0;
		m_currentInstr = nullptr;
		break;
	}
...
void CPU::LD_A_DE()
{
	...
	case 1:
		...
		break;
	case 2:
		m_registers[A] = m_bus.read(getDE());
		m_cycleCounter = 0;
		m_currentInstr = nullptr;
		break;
	}
...
void CPU::LD_BC_A()
{
	...
	case 1:
		...
		break;
	case 2:
		m_bus.write(getBC(), m_registers[A]);
		m_cycleCounter = 0;
		m_currentInstr = nullptr;
		break;
	}
...
void CPU::LD_DE_A()
{
	...
	case 1:
		...
		break;
	case 2:
		m_bus.write(getDE(), m_registers[A]);
		m_cycleCounter = 0;
		m_currentInstr = nullptr;
		break;
	}
...
void CPU::LD_A_nn()
{
	...
	case 3:
		...
		break;
	case 4:
		m_registers[A] = m_bus.read(m_iState.xx);
		m_cycleCounter = 0;
		m_currentInstr = nullptr;
		break;
	}
...
void CPU::LD_nn_A()
{
	...
	case 3:
		...
		break;
	case 4:
		m_bus.write(m_iState.xx, m_registers[A]);
		m_cycleCounter = 0;
		m_currentInstr = nullptr;
		break;
	}
...
void CPU::LDH_A_C()
{
	...
	case 1:
		...
		break;
	case 2:
		m_registers[A] = m_bus.read(0xFF00 | m_registers[C]); //xx is 0xFF00 as the high byte + C as the low byte
		m_cycleCounter = 0;
		m_currentInstr = nullptr;
		break;
	}
...
void CPU::LDH_A_n()
{
	...
	case 2:
		...
		break;
	case 3:
		m_registers[A] = m_bus.read(0xFF00 | m_iState.x);
		m_cycleCounter = 0;
		m_currentInstr = nullptr;
		break;
	}
...
void CPU::LDH_n_A()
{
	...
	case 2:
		...
		break;
	case 3:
		m_bus.write(0xFF00 | m_iState.x, m_registers[A]);
		m_cycleCounter = 0;
		m_currentInstr = nullptr;
		break;
	}
...
void CPU::LD_A_HLd()
{
	...
	case 1:
		...
		break;
	case 2:
		m_registers[A] = m_bus.read(getHL());
...
void CPU::LD_HLd_A()
{
	...
	case 2:
		...
		m_bus.write(getHL(), m_registers[A]);
...
void CPU::LD_nn_SP()
{
	...
	case 3:
		...
		break;
	case 4:
		m_bus.write(m_iState.xx, getLSB(m_SP));
		break;
	case 5:
		m_bus.write(m_iState.xx + 1, getMSB(m_SP));
		m_cycleCounter = 0;
		m_currentInstr = nullptr;
		break;
	}
...
void CPU::ADD_HL()
{
	...
	case 1:
		...
		break;
	case 2:
		m_iState.x = m_bus.read(getHL()); //HL mem
...
void CPU::INC_HL()
{
	...
	case 2:
		...
		break;
	case 3:
		m_bus.write(getHL(), m_iState.x + 1);
...
void CPU::BIT_b_HL()
{
	...
	case 3:
		m_iState.x = (m_IR >> 3) & 0b111; //b
		m_iState.y = m_bus.read(getHL()); //HL mem
...
void CPU::RES_b_HL()
{
	...
	case 4:
		...
		m_bus.write(getHL(), m_iState.x & ~(1 << m_iState.y));
		m_cycleCounter = 0;
		m_currentInstr = nullptr;
	}
}
